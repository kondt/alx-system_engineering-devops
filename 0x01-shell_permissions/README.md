...
### 1. Who am I
* Write a scritp that prints the effective username of the current user
...
### 7. Everybody!
* Write a script that adds execution permission ot the owner, the group owner and the other users, to the file **hello**
  * The file **hello** will be in the working directory
  * Use of commas for this script is not allowed
...
### 8. James Bond
* Write a script that sets the permissions to file **hello** as follows
