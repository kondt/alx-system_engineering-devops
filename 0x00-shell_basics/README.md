...
### 15. Let's move
* Create a script that moves all files beginnig with an uppercase letter to the directory **/tmp/u**
* You can assume that the directory **/tmp/u** will exist when the script is run
